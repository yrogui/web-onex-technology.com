...
export default function PolitiqueCookiesPage() {
  return (
    <div className="min-h-screen bg-brand-cream dark:bg-[#0a0c10] py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-brand-noir dark:text-white mb-6">
          ...
          <p className="text-lg text-brand-slate dark:text-[#94a3b8] leading-relaxed mt-2">
        ...
        {/* Résumé rapide */}
        <div className="bg-white dark:bg-[#1a1c20] rounded-2xl p-8 shadow-sm border border-brand-noir/10 dark:border-white/[0.05] mb-12">
          <h2 className="text-2xl font-bold text-brand-noir dark:text-white mb-4 flex items-center gap-3">
            <Shield className="h-6 w-6 text-brand-gold" />
            En résumé
          </h2>
          <ul className="space-y-3 text-brand-slate dark:text-[#94a3b8]">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="font-serif text-3xl font-bold text-brand-noir dark:text-white mb-6 flex items-center gap-3">
          ...
          <section className="mb-12">
            ...
            {/* Essentiels */}
            <div className="bg-white dark:bg-[#1a1c20] rounded-xl p-6 shadow-sm border border-brand-noir/10 dark:border-white/[0.05] mb-6">
              <h3 className="text-xl font-bold text-brand-noir dark:text-white mb-3 flex items-center gap-2">
                <Cookie className="h-5 w-5 text-green-600" />
                Cookies essentiels (obligatoires)
              </h3>
              <p className="text-brand-slate dark:text-[#94a3b8] mb-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-brand-cream/50 dark:bg-white/5">
                    <tr>
                      <th className="px-4 py-3 text-left font-semibold text-brand-noir dark:text-white">Nom</th>
                      <th className="px-4 py-3 text-left font-semibold text-brand-noir dark:text-white">Finalité</th>
                      <th className="px-4 py-3 text-left font-semibold text-brand-noir dark:text-white">Durée</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-brand-noir/10 dark:divide-white/[0.05]">
                    <tr>
                      <td className="px-4 py-3 font-mono text-xs text-brand-noir dark:text-white">onex-cookie-consent</td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">
                        Stocke votre choix de consentement cookies (accepter/refuser/personnaliser)
                      </td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">6 mois</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-mono text-xs text-brand-noir dark:text-white">onex-theme</td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">
                        Mémorise votre préférence de thème (mode clair/sombre)
                      </td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">12 mois</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-white dark:bg-[#1a1c20] rounded-xl p-6 shadow-sm border border-brand-noir/10 dark:border-white/[0.05] mb-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-brand-noir/10 dark:divide-white/[0.05]">
                    <tr>
                      <td className="px-4 py-3 font-mono text-xs text-brand-noir dark:text-white">Google Fonts</td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">
                        Chargement optimisé des polices Inter et Playfair Display depuis les serveurs Google
                      </td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">Session</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-white dark:bg-[#1a1c20] rounded-xl p-6 shadow-sm border border-brand-noir/10 dark:border-white/[0.05] mb-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-brand-noir/10 dark:divide-white/[0.05]">
                    <tr>
                      <td className="px-4 py-3 font-mono text-xs text-brand-noir dark:text-white">_ga</td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">
                        Google Analytics 4 - Identifie les visiteurs uniques de manière anonyme
                      </td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">2 ans</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-mono text-xs text-brand-noir dark:text-white">_gid</td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">
                        Google Analytics 4 - Distingue les utilisateurs
                      </td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">24 heures</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-mono text-xs text-brand-noir dark:text-white">_gat</td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">
                        Google Analytics 4 - Limite le taux de requêtes
                      </td>
                      <td className="px-4 py-3 text-brand-slate dark:text-[#94a3b8]">1 minute</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            {/* Marketing */}
            <div className="bg-white dark:bg-[#1a1c20] rounded-xl p-6 shadow-sm border border-brand-noir/10 dark:border-white/[0.05]">
              <h3 className="text-xl font-bold text-brand-noir dark:text-white mb-3 flex items-center gap-2">
              ...
              <div className="bg-brand-gold/10 rounded-lg p-4 text-sm text-brand-noir dark:text-white">
          ...
          <section className="mb-12">
            ...
            <div className="bg-white dark:bg-[#1a1c20] rounded-xl p-6 shadow-sm border border-brand-noir/10 dark:border-white/[0.05]">
              <p className="text-brand-slate dark:text-[#94a3b8] leading-relaxed mb-4">
              ...
              <div className="mt-6 p-4 bg-brand-gold/10 rounded-lg">
                <p className="text-brand-noir dark:text-white font-medium mb-2">
                ...
                <p className="text-brand-slate dark:text-[#94a3b8] text-sm mt-2">
          ...
          {/* CTA final */}
          <section className="bg-gradient-to-br from-brand-gold/10 to-brand-gold/5 dark:from-brand-gold/5 dark:to-brand-gold/10 rounded-2xl p-8 border border-brand-gold/20">
            <h3 className="text-2xl font-bold text-brand-noir dark:text-white mb-4">
              Besoin d'aide ?
            </h3>
